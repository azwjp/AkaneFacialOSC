...
namespace Azw.FacialOsc
{
    ...
    {
        public static TrackingType GetTrackingType(FaceKey key)
        {
            switch(GetDataType(key))
            {
                case DataType.Eye:
                case DataType.Gaze:
                case DataType.ComputedEye:
                    return TrackingType.Eye;
                case DataType.Facial:
                case DataType.ComputedFacial:
                    return TrackingType.Lip;
                default:
                    throw new UnexpectedEnumValueException(key);
            }
        }
