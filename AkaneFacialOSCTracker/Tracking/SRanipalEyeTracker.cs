...
{
    internal class SRanipalEyeTracker : Tracker
    {
        ...
        {
            deviceStatus = SRanipal_API.Initial(SRanipal_Eye.ANIPAL_TYPE_EYE_V2, IntPtr.Zero);
        }

        public override void StopProcess()
        {
            deviceStatus = SRanipal_API.Release(SRanipal_Eye.ANIPAL_TYPE_EYE_V2);
        }
