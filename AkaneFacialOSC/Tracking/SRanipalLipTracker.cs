...
namespace Azw.FacialOsc.Tracking
{
    internal class SRanipalLipTracker : LipTracker
    {
        ...
        {
            return Task.Run(() => deviceStatus = SRanipal_API.Initial(SRanipal_Lip.ANIPAL_TYPE_LIP_V2, IntPtr.Zero));
        }

        public override Task<Error> StopProcess()
        {
            return Task.Run(() => deviceStatus = SRanipal_API.Release(SRanipal_Lip.ANIPAL_TYPE_LIP_V2));
        }
